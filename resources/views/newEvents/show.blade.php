    ...
    <div class="card" style="margin-top: 20px">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <a href="images/test.png" download>download</a>
                <p class="card-text"><i class="fa fa-download"></i>File: <a href="{{ asset('/images/' . $newEvents->join_file_new_event) }}" download>{{$newEvents->join_file_new_event}}</a></p>
